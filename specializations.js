...
// أسئلة الاختبار التفاعلي المحدثة لعام 2026
export const questions = [
  {
    ...
    options: [
      { text: "الرعاية الصحية وإنقاذ الأرواح", value: "medical", weight: 3 },
      { text: "بناء الأنظمة الرقمية وحماية البيانات", value: "tech_engineering", weight: 3 },
      { text: "تطوير الطاقة والبنى التحتية للمدن", value: "energy_infra", weight: 3 },
      { text: "إدارة الأموال والابتكار في الأعمال", value: "business_fintech", weight: 3 }
    ]
  },
  {
    id: 2,
    ...
    options: [
      { text: "تشخيص الأمراض وفهم جسم الإنسان", value: "medical", weight: 2 },
      { text: "إصلاح الثغرات الأمنية أو كتابة الأكواد", value: "tech_engineering", weight: 2 },
      { text: "تصميم أنظمة طاقة مستدامة أو أتمتة مصانع", value: "energy_infra", weight: 2 },
      { text: "تحليل الأسواق وتطوير حلول دفع ذكية", value: "business_fintech", weight: 2 }
    ]
  },
  {
    id: 3,
    ...
    options: [
      { text: "مستشفى متطور أو مختبر أبحاث", value: "medical", weight: 2 },
      { text: "مركز عمليات رقمي (SOC) أو شركة تقنية", value: "tech_engineering", weight: 2 },
      { text: "موقع عمل ميداني أو محطة طاقة ذكية", value: "energy_infra", weight: 2 },
      { text: "بنك رقمي أو شركة استشارات أعمال", value: "business_fintech", weight: 2 }
    ]
  },
  {
    id: 4,
    ...
    options: [
      { text: "الدقة الطبية والتعامل مع المرضى", value: "medical", weight: 3 },
      { text: "البرمجة المتقدمة وحماية الأنظمة", value: "tech_engineering", weight: 3 },
      { text: "الهندسة الميدانية والتحكم الآلي", value: "energy_infra", weight: 3 },
      { text: "التحليل المالي والاستراتيجيات الرقمية", value: "business_fintech", weight: 3 }
    ]
  },
  {
    id: 5,
    ...
    options: [
      { text: "المساهمة في تحسين الصحة العامة", value: "medical", weight: 2 },
      { text: "قيادة التحول الرقمي في البلاد", value: "tech_engineering", weight: 2 },
      { text: "تأمين طاقة مستدامة وبناء الوطن", value: "energy_infra", weight: 2 },
      { text: "بناء اقتصاد رقمي قوي ومبتكر", value: "business_fintech", weight: 2 }
    ]
  }
];

// خوارزمية حساب النتائج
export const calculateResults = (answers) => {
  ...
  const sortedResults = Object.entries(scores)
    ...
    .map(([category, score]) => ({
      category,
      score,
      percentage: Math.round((score / 12) * 100) // 12 هو مجموع الأوزان القصوى
    }));
